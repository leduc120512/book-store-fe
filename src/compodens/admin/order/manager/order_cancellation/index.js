...
import styles from "./orderss-module.scss";
...
const OrderTable = () => {
  ...
  const handleAccept = (id) => {
    axios
      .patch(`http://localhost:3000/orders/${id}`, { accept: true })
      .then(() => {
        fetchOrders();
      })
      ...
      <Table>
        <TableHead>
          <TableRow>
            ...
            <TableCell className={cx("Order_table")}>Delete</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
